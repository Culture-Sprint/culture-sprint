...
/**
 * Core functionality for slider questions that is shared between fetch and save hooks
 */
export const useSliderQuestionsCore = (projectId: string) => {
  ...
  const logDebug = (message: string, ...args: any[]) => {
    console.log(`[SliderQuestions] ${message}`, ...args);
  };
